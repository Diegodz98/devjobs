        ...
        <div class="flex flex-wrap row justify-center">
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                    <div class="bg-gray-300  text-gray-700 uppercase text-center py-3 px-6 mb-5">{{ __('Login') }}</div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="py-10 px-5" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="email" class="block text-gray-700 text-sm mb-2">{{ __('Password') }}</label>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <label class="block text-gray-700 text-sm mb-" for="remember">
                                {{ __('Remember Me') }}
                            </label>
                        </div>
                        ...
                        <div class="flex flex-wrap">
                            ...
                            @if (Route::has('password.request'))
                                <a class="text-sm  text-gray-500 mt-5 w-full text-center"
