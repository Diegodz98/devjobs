    ...
    <div class="container mx-auto max-w-screen-md">
        <div class="flex flex-wrap justify-center">
            <div class="md:w-1/2 order-2 md:order-1">
                <div class="w-full max-w-sm">
                    <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                        <div class="bg-gray-300  text-gray-700 uppercase text-center py-3 px-6 mb-5">{{ __('Register') }}
                        </div>
                        <form method="POST" action="{{ route('register') }}" class="py-10 px-5" novalidate>
                            @csrf

                            <div class="flex flex-wrap mb-6">
                                <label for="name" class="block text-gray-700 text-sm mb-2t">{{ __('Name') }}</label>
                            ...
                            <div class="flex flex-wrap mb-6">
                                <label for="email"
                                    class="block text-gray-700 text-sm mb-2t">{{ __('E-Mail Address') }}</label>
                            ...
                            <div class="flex flex-wrap mb-6">
                                <label for="password-confirm"
                                    class="block text-gray-700 text-sm mb-2t">{{ __('Confirm Password') }}</label>
            ...
            <div class="md:w-1/2 order-1 md:order-2  text-center flex flex-col justify-center px-10 mt-10">
                ...
                <p class="text-xl mt-5 leading-7">Crea una cuenta totalmente gratis y publica hasta 10 vacates</p>
            </div>
